...
- For hard tasks, use `planner`, Sonnet implementation, one evidence-based repair attempt, `planner` again for Opus replanning with the complete evidence bundle, revised implementation, and then `adversarial-reviewer`.
